...
<html lang="en">
  <head>
    ...
    <title>Register - Adiandra Medika</title>
    <!-- plugins:css -->
              ...
              <div class="auth-form-light text-left p-5">
                ...
                <form class="pt-3" method="POST" action="{{ route('register') }}">
                  ...
                  <div class="form-group">
                    <input type="text" name="name" class="form-control form-control-lg @error('name') is-invalid @enderror" value="{{ old('name') }}" id="exampleInputUsername1" placeholder="Username">
                    @error('name')
                ...
                @enderror 
                  ...
                  <div class="form-group">
                    <input type="password" name="password" class="form-control form-control-lg @error('password') is-invalid @enderror"  value="{{ old('password') }}" id="exampleInputPassword1" placeholder="Password">
                    @error('password')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group">
                    <input type="password" name="password_confirmation" class="form-control form-control-lg" value="{{ old('password_confirmation') }}" id="exampleInputPassword2" placeholder="Confirm Password">

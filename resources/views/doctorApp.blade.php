...
<html lang="en">
  <head>
    ...
    <title>@yield('title') - Adiandra Medika</title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="#">Adiandra.medika</a>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('operatorHome')}}">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('bookingOpr')}}">
            ...
            {{-- <li class="nav-item">
              ...
              <div class="collapse" id="ui-news">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Post</a></li>
                </ul>
              </div>
            </li> --}}
            {{-- <li class="nav-item">
            ...
            {{-- <li class="nav-item">
              <a class="nav-link" href="{{route('laporan_booking')}}">
        ...
        <div class="main-panel">
          ...
          <footer class="footer">
            <div class="container-fluid clearfix">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © adiandra.medika</span>

            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col"> 
                    <p>{{$show_booking_admin->category->name}}</p>     
                  </div>
                </div>
                <div class="row">
                  <div class="col">
                  ...
                  <div class="col">
                      <p>{{$show_booking_admin->service->pelayanan}}</p>
                  </div>
                  </div>
                  <div class="row">
                    <div class="col">
                    ...
                    <div class="col">
                      <p>{{$show_booking_admin->doctor->name}}</p>
                    </div>
                  </div>
                <div class="row">
                  <div class="col">
                  ...
                  <div class="col">
                    <p>{{$show_booking_admin->tanggal}}</p>

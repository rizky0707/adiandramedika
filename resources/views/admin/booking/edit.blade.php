              ...
              <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="{{route('booking.update', $edit->id)}}">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="nama" value="{{$edit->nama}}" class="form-control" id="name" placeholder="Name">
                    @if(count($errors) > 0)
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" value="{{$edit->nohp}}" name="nohp" class="form-control" id="name" placeholder="No HP">
                    @if(count($errors) > 0)
                    @foreach ($errors->all() as $error)
                    <small id="emailHelp" class="form-text text-warning">Category sudah ada / Category harus lebih dari 2 huruf</small>
                    @endforeach
                  ...
                  <div class="form-group">
                    <label>Lokasi</label>
                      <select class="form-control productcategory" name="lokasi" id="lokasi">
                        ...
                        <option value="Adiandra Medika Turangga - Bandung" {{$edit->lokasi == 'Adiandra Medika Turangga - Bandung' ? 'selected' : ''}}>Adiandra Medika Turangga - Bandung</option>
                        <option value="Adiandra Medika BSD - Jakarta" {{$edit->lokasi == 'Adiandra Medika BSD - Jakarta' ? 'selected' : ''}}>Adiandra Medika BSD - Jakarta</option>
                      </select>
                  </div>
                  <div class="row">
                  <div class="col">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group form-check-inline">
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="alamat" id="" class="form-control" cols="30" rows="10">{{$edit->alamat}}</textarea>
                        @if(count($errors) > 0)
                        @foreach ($errors->all() as $error)
                        <small id="emailHelp" class="form-text text-warning">Category sudah ada / Category harus lebih dari 2 huruf</small>
                        @endforeach

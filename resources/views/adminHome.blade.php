...
<div class="content-wrapper">
      ...
      <div class="col-md-4 stretch-card grid-margin">
        <div class="card bg-gradient-info card-img-holder text-white">
          <div class="card-body">
            ...
            <h6 class="card-text">Adiandra.medika</h6>
          </div>
        </div>
      </div>
      <div class="col-md-4 stretch-card grid-margin">
    ...
    @endif --}}
            <div class="row">
                <div class="col">
                <h6 class="m-0 font-weight-bold text-primary card-title">Data Antrian </h6>
                </div>
                {{-- <div class="col text-right">
                    <a href="{{route('booking.create')}}" class="btn btn-primary btn-sm">Create Booking</a>
                </div> --}}
            ...
            <table class="table table-bordered" width="80%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                   <a href="https://wa.me/{{$item->nohp}}?text=*ANTRIAN%20ADIANDRA%20MEDIKA*%0ANAMA%20%3A%20{{$item->nama}}%0ANOMOR%20%3A%20{{$no++}}%0A---------------------------%0ATerima%20Kasih%20" class="btn btn-outline-success btn-sm" >WA</a>
                  </td>
                </tr>
                @else 
